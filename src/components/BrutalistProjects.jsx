...
const projectsList = [
  {
    ...
    description: 'Concurrent Go telemetry agent silently monitoring API traffic, detecting anomalies, and running Claude LLMs for automated zero-latency root cause fixes.',
  ...
  },
  {
    ...
    specs: 'CHROMADB EMBEDDINGS | ~48ms VECTOR MATCH | 0% HALLUCINATION',
    description: 'WhatsApp-inspired RAG platform indexing corporate documents with ChromaDB vector embeddings for zero-hallucination document Q&A.',
